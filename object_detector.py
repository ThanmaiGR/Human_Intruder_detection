        ...
        if success:
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    cvzone.putTextRect(img, f'{class_names[cls]} {conf}', (max(0, x1), max(30, y1)))
    ...
    for image_name in os.listdir(folder_path):
        ...
        for r in results:
            ...
            for box in boxes:
                ...
                cls = int(box.cls[0])
                # Display the object's class name and confidence level on the frame
                cvzone.putTextRect(image, f'{class_names[cls]} {conf}', (max(0, x1), max(30, y1)))
...
class_names = ["intruder", "student",]
path = r"../human_intrusion_data_2/test/images/"
